                            ...
                            <Box component={'div'} sx={{
                                ...
                                <div style={{ padding: '0 24px' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                        <p style={{ fontSize: "18px", lineHeight: "27px", fontWeight: 500 }}>Thẻ thanh toán</p>
                                        <div>
                                            <img src="https://ik.imagekit.io/tvlk/image/imageResource/2017/01/17/1484655630637-0dcca3761eb5910f1835f438f153bfae.png?tr=q-75" alt="" style={{ height: '24px', paddingLeft: '10px' }} />
                                            <img src="https://ik.imagekit.io/tvlk/image/imageResource/2017/01/06/1483707776912-1abb188266f6d5b3f2e27f4733ca32e9.png?tr=q-75" alt="" style={{ height: '24px', paddingLeft: '10px' }} />
                                            <img src="https://ik.imagekit.io/tvlk/image/imageResource/2017/01/06/1483707787206-abc175b224ab92a6967e24bc17c30f45.png?tr=q-75" alt="" style={{ height: '24px', paddingLeft: '10px' }} />
                                            <img src="https://ik.imagekit.io/tvlk/image/imageResource/2017/07/10/1499673365437-1e1522e5cc323e7e8a7b57b90e81dbc9.png?tr=q-75" alt="" style={{ height: '24px', paddingLeft: '10px' }} />
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            <p className={classes.label}>Số thẻ tín dụng</p>
                                            <input className={classes.input} placeholder="18 chữ số trên mặt thẻ" />
                                        </div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                            <div>
                                                <p className={classes.label}>Hiệu lực đến</p>
                                                <input className={classes.input} placeholder="MM/YY" />
                                            </div>
                                            <div>
                                                <p className={classes.label}>CVV</p>
                                                <input className={classes.input} placeholder="3 chữ số CVV" />
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input className={classes.input} placeholder="Tên trên thẻ" style={{ marginBottom: '5px' }} />
                                        </div>
                                    </div>
                                </div>
                                <hr />
                                <div style={{ padding: '0 24px', marginBottom: '20px' }}>
                                    ...
                                    <a href="" style={{ color: '#0000ee' }}>Learn more</a>
                                </div>
                                <hr />
                                <div style={{ padding: '18px 24px' }}>
                                    ...
                                    {checked && <div>
                                        <input placeholder='VD: CHEAPTRAVEL' style={{ padding: "8px 16px", border: "1px solid #dadada", outline: 'none', fontSize: '14px', margin: '16px 20px 0 0' }} />
                        ...
                        <Box component={'div'} sx={{
                            ...
                            <div className={classes.datcho}>
                                ...
                                <div style={{ padding: '16px' }}>
                                    ...
                                    <p style={{ fontSize: '14px', fontWeight: '700', margin: '5px 0' }}>{TENTOUR}</p>
