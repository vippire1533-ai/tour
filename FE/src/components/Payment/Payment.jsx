...
function Payment() {
  ...
  const tongTien =
    booking.soluongtreem * 500000 + booking.soluongnguoilon * 650000 + 100000;
  useEffect(() => {
    getData(id);
  }, [id]);
  ...
  return (
    <Fragment>
      <Header />
      {singleOderproducttour.map(({ TENTOUR }) => (
        <Box
          component={'div'}
          sx={{
                      ...
                      <div className={classes.chitietgia}>
                        ...
                        <p>
                          <NumberFormat
                            ...
                            value={booking.soluongnguoilon * 650000}
                          />{' '}
                          VND
                        </p>
                      </div>
                      <div className={classes.chitietgia}>
                        ...
                        <p>
                          <NumberFormat
                            ...
                            displayType={'text'}
                            thousandsGroupStyle='thousand'
                            value={booking.soluongtreem * 500000}
                          />{' '}
                          VND
                        </p>
                      </div>
