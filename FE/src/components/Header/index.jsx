                ...
                <div className="hd-login-sub dropdown-list">
                  <div className="hd-login">
                    ...
                    <div className="hd-gr-input">
                      ...
                      <div className="hd-gr-input">
                        <input type="text" className="hd-input" onChange={(e) => { setUsername(e.target.value) }} />
                      </div>
                    </div>
                    <div className="hd-gr-input">
                      <div className="hd-title-input">
                      ...
                      <div className="hd-gr-input">
                        <input type={type} className="hd-input" onChange={(e) => { setPassword(e.target.value) }} />
                        <img
                          onClick={() => {
                            type === "password"
                              ? setType("text")
                    ...
                    <div className="hd-gr">
                      <button className="hd-btn-login">
                        <a onClick={() => { hanleLogin({ username: username, password: password }) }} style={{ textDecoration: "none", color: "#fff" }}>Đăng nhập</a>
                      </button>
