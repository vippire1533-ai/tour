  ...
  return (
    <Fragment>
      ...
      <div className='page-rigister'>
        <Collapse in={open}>
          <Alert>Yêu cầu của bạn đã được xử lý thành công</Alert>
        </Collapse>
        <div className='title'>
        ...
        <div className='form-rigister'>
          <div className='content-left'>
            <div className='content-endow'>
              <img
                src='https://ik.imagekit.io/tvlk/image/imageResource/2018/07/03/1530614225701-39530c6a0da573b6c3e09f76039ca6d4.svg?tr=h-65,q-75,w-65'
                alt='img'
              />
          ...
          <div className='content-right'>
            <div className='content-endow'>
              ...
              <div className='content-endow-value'>
                <p>
                  Xem vé điện tử và phiếu thanh toán khi không có kết nối mạng. Hoàn tiền hoặc đổi lịch dễ dàng khi bạn
                  phải thay đổi kế hoạch.<a href='#'> Tìm hiểu thêm</a>
                </p>
              </div>
            </div>
            ...
            <div className='content-endow'>
              ...
              <div className='content-endow-value'>
                <p>
                  Tính năng Thông báo giá giúp bạn dễ dàng đặt vé vào thời điểm thích hợp nhất. Điền thông tin hành
                  khách trong nháy mắt với Passenger Quick Pick.{' '}
                </p>
                <a href='#'> Tìm hiểu thêm</a>
              </div>
            </div>
              ...
              <div className='info-register'>
                <>
                  ...
                  <div style={{ padding: '0 20px' }}>
                    <Formik
                      initialValues={{ username: '', email: '', password: '', role: ['user', 'moderator'] }}
                      validate={(values) => {
                        const errors = {};
                        return errors;
                      }}
                      onSubmit={(values, { setSubmitting }) => {
                        ...
                        axios({
                          url: 'https://be-profile-app.herokuapp.com/api/auth/signup',
                          method: 'POST',
                          data: values,
                        })
                          .then((res) => {
                          ...
                          .catch((err) => {
                            ...
                            Swal.fire({
                              icon: 'error',
                              title: `Đăng ký thất bại. ${err.message}`,
                              confirmButtonText: 'OK',
                            });
                            dispatch(appActions.hideLoading());
                          });
                  ...
                  <div className='fb'>
                    <div className='fb-icon'>
                      <img
                        src='https://d1785e74lyxkqq.cloudfront.net/_next/static/v2/5/5f2c27c2674ad4a01c1cd42b2e0884aa.svg'
                        alt='icon-fb'
                      />
                    </div>
                    &nbsp;
                    <div className='fb-name'>Facebook</div>
                  </div>
                  <div className='gg'>
                    ...
                    &nbsp;
                    <div className='fb-name'>Google</div>
                  </div>
                  <div className='security'>
                    ...
                    <div className='security-content'>
                      Bảo mật đa lớp bao gồm thông báo khi đăng nhập, mã xác thực và xác thực bằng vân tay.
                      <a>Tìm hiểu thêm</a>
                    </div>
                  </div>
                  <div className='author'>© 2022 Traveloka</div>
                </>
              </div>
            </div>
          </div>
