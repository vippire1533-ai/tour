      ...
      {singleOderproducttour.map(({ MATOUR, GIATOUR }) => (
        <div>
          <div className={classes.login}>
            ...
            />
            <h2>Đăng nhập hoặc đăng ký và tận hưởng ưu đãi dành riêng cho thành viên</h2>
          ...
          <div className={classes.fillform}>
            <div className={classes.fillother}>
              ...
              <br />
              <p>
                Định dạng: bằng tiếng Anh hoặc ngôn ngữ địa phương tại điểm đến. Yêu cầu tuỳ vào tình hình thực tế của
                nhà cung cấp.
              </p>
            </div>
          </div>
          ...
          <div className={classes.fillform}>
            ...
            <div className={classes.dangnhap}>
              ...
              <p>
                {' '}
                Đăng nhập hoặc Đăng ký để tích ngay điểm thưởng! Bạn có thể tiếp tục đặt chỗ sau vì tiến trình đã được
                lưu trên hệ thống.
              </p>
              <br />
              <a href=''>Đăng nhập</a>
          ...
          <button className={classes.tieptuc} onClick={() => navigate('/payment/' + MATOUR)}>
            Tiếp tục
          </button>
        </div>
      ))}
